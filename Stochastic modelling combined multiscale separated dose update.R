...
dose1 <- c((10*10^6)*patient_weight,0,0,0) #units of cells
...
path <- "Final_models/Reactions8Naive_10-6Tumor50-3" #Change based on order of reactions, dose of CAR-T cells/kg and tumor size in ul.
